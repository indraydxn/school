...
<body style="margin: 15mm; padding: ; font-family: 'Times New Roman', Times, serif; font-size: 12px; line-height: 1.2; color: #111;">
    <div class="layout-wrapper" style="padding: 8px 12px 12px;">
        ...
        <h1 class="section-title" style="font-size: 18px; font-weight: 700; margin: 18px 0 4px; text-align: center; text-transform: uppercase; letter-spacing: 0.6px;">Data Pengguna Aplikasi</h1>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 8px;">
            <thead>
                <tr>
                    ...
                    <th style="border: 0.6px solid #555; padding: 6px 8px; background-color: #f3f3f3; font-weight: 700; text-align: center; font-size: 12px; text-transform: uppercase;">Gender</th>
                    ...
                    <th style="border: 0.6px solid #555; padding: 6px 8px; background-color: #f3f3f3; font-weight: 700; text-align: center; font-size: 12px; text-transform: uppercase;">Role</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr @if($loop->iteration % 2 === 0) style="background-color: #fafafa;" @endif>
                    ...
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $user->nama_lengkap }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $user->jenis_kelamin }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $user->telepon }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $user->email }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $user->status ? 'Aktif' : 'Tidak aktif' }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top; text-transform: capitalize">{{ $user->roles->pluck('name')->implode(', ') ?: 'Tidak ada role' }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
