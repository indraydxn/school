...
<body style="margin: 15mm; padding: ; font-family: 'Times New Roman', Times, serif; font-size: 12px; line-height: 1.2; color: #111;">
    <div class="layout-wrapper" style="padding: 8px 12px 12px;">
        ...
        <h1 class="section-title" style="font-size: 18px; font-weight: 700; margin: 18px 0 4px; text-align: center; text-transform: uppercase; letter-spacing: 0.6px;">Data Wali Siswa</h1>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 8px;">
            <thead>
                <tr>
                    ...
                    <th style="border: 0.6px solid #555; padding: 6px 8px; background-color: #f3f3f3; font-weight: 700; text-align: center; font-size: 12px; text-transform: uppercase;">Hubungan</th>
                    <th style="border: 0.6px solid #555; padding: 6px 8px; background-color: #f3f3f3; font-weight: 700; text-align: center; font-size: 12px; text-transform: uppercase;">Siswa</th>
                    ...
                    <th style="border: 0.6px solid #555; padding: 6px 8px; background-color: #f3f3f3; font-weight: 700; text-align: center; font-size: 12px; text-transform: uppercase;">Pekerjaan</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($wali as $w)
                <tr @if($loop->iteration % 2 === 0) style="background-color: #fafafa;" @endif>
                    ...
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $w->user->nama_lengkap ?? '' }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $w->hubungan ?? '' }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $w->student->user->nama_lengkap ?? '' }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $w->pendidikan_terakhir ?? '' }}</td>
                    <td style="border: 0.6px solid #555; padding: 6px 8px; font-size: 11px; vertical-align: top;">{{ $w->pekerjaan ?? '' }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
