                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead>
                                        <tr class="divide-x divide-gray-200">
                                            ...
                                            <th scope="col" class="px-6 py-2 whitespace-nowrap text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NIS</th>
                                            <th scope="col" class="px-6 py-2 whitespace-nowrap text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NISN</th>
                                            <th scope="col" class="px-6 py-2 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Tahun Masuk</th>
                                        ...
                                        <tr class="divide-x divide-gray-200">
                                            ...
                                            <td class="px-4 py-2 whitespace-nowrap tracking-wider text-center">
                                                <label class="flex items-center justify-center space-x-2">
                                                    <input type="checkbox" {{ $s->user->status ? 'checked' : '' }} wire:click="toggleStatus({{ $s->user->id }})" wire:loading.attr="disabled" class="form-switch h-5 w-10 rounded-full bg-gray-300 before:rounded-full before:bg-gray-50 checked:bg-primary checked:before:bg-white"/>
                                                </label>
                                            </td>
                                            ...
                                            {{-- NIS --}}
                                            <td class="px-6 py-2 whitespace-nowrap tracking-wider text-left text-gray-500">
                                                {{ $s->nis }}
                                            </td>
                                            ...
                                            <td class="px-4 py-2 whitespace-nowrap font-medium">
                                                <x-backend.actions
                                                    :data="$s"
                                                    :name="$s->user->nama_lengkap ?? 'Siswa'"
                                                    :view="false"
                                                    :edit="true"
                                                    :delete="true"
