                ...
                <div class="space-y-4 px-6 py-4 h-[400px] overflow-hidden overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block space-y-1">
                            ...
                            <input type="email" id="email" wire:model="email" placeholder="Masukkan Email" autocomplete="off" class="form-input tracking-wide w-full rounded-lg border border-gray-200 bg-transparent px-3 py-2 placeholder:text-gray-400/70 hover:border-gray-400 focus:border-primary"/>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block space-y-1">
                            ...
                            <input type="date" id="tanggal_lahir" wire:model="tanggal_lahir" placeholder="Masukkan Tanggal Lahir" autocomplete="off" class="form-input tracking-wide w-full rounded-lg border border-gray-200 bg-transparent px-3 py-2 placeholder:text-gray-400/70 hover:border-gray-400 focus:border-primary"/>
                        ...
                        <label class="block space-y-1">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <label for="jenis-kelamin-l" class="flex gap-2 items-center px-3 py-2 w-full border border-gray-200 rounded-lg text-sm focus:border-primary focus:ring-primary  has-[:checked]:text-primary has-[:checked]:bg-primary/10 has-[:checked]:border-primary">
                                    <input type="radio" wire:model="jenis_kelamin" value="L" required class="form-radio is-basic size-4 rounded-full border-gray-200 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary">
                                ...
                                <label for="jenis-kelamin-p" class="flex gap-2 items-center px-3 py-2 w-full border border-slate-200 rounded-lg text-sm focus:border-secondary focus:ring-secondary has-[:checked]:text-secondary has-[:checked]:bg-secondary/10 has-[:checked]:border-secondary">
                                    <input type="radio" wire:model="jenis_kelamin" value="P" required class="form-radio is-basic size-4 rounded-full border-gray-200 checked:border-secondary checked:bg-secondary hover:border-secondary focus:border-secondary">
                        ...
                        <label class="block space-y-1">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <label for="status-nonaktif" class="flex gap-2 items-center px-3 py-2 w-full border border-slate-200 rounded-lg text-sm focus:border-error focus:ring-error has-[:checked]:text-error has-[:checked]:bg-error/10 has-[:checked]:border-error">
                                    <input type="radio" name="status" id="non-akitf" value="0" required class="form-radio is-basic size-4 rounded-full border-gray-200 checked:border-error checked:bg-error hover:border-error focus:border-error">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block space-y-1">
                            ...
                            <select id="role" name="role" required class="form-input tracking-wide w-full rounded-lg border border-gray-200 bg-transparent px-3 py-2 placeholder:text-gray-400/70 hover:border-gray-400 focus:border-primary">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block space-y-1 col-span-12">
                            ...
                            <textarea id="alamat" name="alamat" required placeholder="Masukkan Alamat" autocomplete="off" class="form-input tracking-wide w-full rounded-lg border border-gray-200 bg-transparent px-3 py-2 placeholder:text-gray-400/70 hover:border-gray-400 focus:border-primary"></textarea>
