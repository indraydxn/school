...
class Create extends Component
{
    ...
    public function store()
    {
        ...
        // no_staf
    $jabatanId = $this->jabatan_id;
    // Ubah query: gunakan whereDate untuk match tanggal saja
    $maxUrut          = Staf::where('jabatan_id', $jabatanId)->whereDate('tanggal_masuk', $this->tanggal_masuk)->max(DB::raw('substr(no_staf, -3)')) ?? 0;
    $counter          = $maxUrut + 1;
